...
var _prelink = './sources/game/' + window.location.href.split("game/")[1] + '/';
// this.prelink =  this.prelink ("?")[0] + '/';
if(_prelink.indexOf("?") !== -1){
   _prelink = _prelink.split("?")[0] + '/';
}
// console.log(JSON.stringify( window.location.href.split("game/")))
// this.prelink = this.prelink.split("?")[0];
console.log("prelink " + _prelink);